...
function handleFav(event){
  ...
  return (
    ...
    >
      ...
      ></img>
      <h3>Name : {name}</h3>
      <button onClick={handleFav}>{isFav ? "Add to Favourite" : "Remove from Favourite"}</button>
      <p>Category : {category}</p>
      <p>Price : {price}</p>
      <div style={{display:"flex", justifyContent:"space-evenly", marginTop:"5px", padding:"5px"} }>
